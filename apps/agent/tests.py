...
class AgentChatPageTests(TestCase):
    def test_agent_page_renders_without_backend_request(self):
        ...
        self.assertContains(response, "body.getReader")
        self.assertContains(response, "TextDecoder")
        self.assertContains(response, 'eventType === "start"')
        self.assertContains(response, 'eventType === "delta"')
        self.assertContains(response, 'eventType === "done"')
